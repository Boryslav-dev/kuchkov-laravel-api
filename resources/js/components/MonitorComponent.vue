<template>
    <div>
        ...
        <div class="row row-cols-xs-1 row-cols-md-1 row-cols-sm-1 row-cols-lg-2 g-2 mt-4">
            <div class="col mb-3">
            ...
            <div class="col mb-3">
                <div class="hovereffect card bg-dark text-white">
                    <img class="img-responsive" src="../../../public/images/images/img.png" alt="">
                    <div class="overlay">
                        <p class="card-title mt-5">Danger Zones</p>
                        ...
                        <h1 class="card-text" v-if="dangerZoneStatus === false">Danger Zones</h1>
                        <h1 class="card-text text-danger" v-else>Danger Zones</h1>
                    </div>
                </div>
            </div>
            <div class="col mb-3"
